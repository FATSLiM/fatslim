...
static char __pyx_k_ref_coords[] = "ref_coords";
static char __pyx_k_MemoryError[] = "MemoryError";
static char __pyx_k_neighborhood[] = "neighborhood";
static char __pyx_k_pyx_getbuffer[] = "__pyx_getbuffer";
static char __pyx_k_allocate_buffer[] = "allocate_buffer";
static char __pyx_k_dtype_is_object[] = "dtype_is_object";
static char __pyx_k_neighbor_coords[] = "neighbor_coords";
static char __pyx_k_neighbor_search[] = "neighbor_search";
static char __pyx_k_neighborhood_py[] = "neighborhood_py";
static char __pyx_k_ref_coords_bbox[] = "ref_coords_bbox";
static char __pyx_k_fatslimlib_core_ns[] = "fatslimlib.core_ns";
static char __pyx_k_strided_and_direct[] = "<strided and direct>";
static char __pyx_k_neighbor_coords_box[] = "neighbor_coords_box";
...
static char __pyx_k_FATAL_Could_not_allocate_memory[] = "FATAL: Could not allocate memory for NS grid.nbeads (requested: %i bytes)\n";
static char __pyx_k_Performing_a_neighbor_search_on[] = "Performing a neighbor search on %i beads using a cutoff of %.2f (%i threads used)";
static char __pyx_k_home_sbuchoux_Hacking_fatslim_f[] = "/home/sbuchoux/Hacking/fatslim/fatslimlib/core_ns.pyx";
...
static char __pyx_k_FATAL_Could_not_allocate_memory_2[] = "FATAL: Could not allocate memory for NS allocated_size (requested: %i bytes)\n";
static char __pyx_k_FATAL_Could_not_allocate_memory_3[] = "FATAL: Could not allocate memory for NS grid.beadids (requested: %i bytes)\n";
static char __pyx_k_FATAL_Could_not_allocate_memory_4[] = "FATAL: Could not allocate memory for NS grid.beadids[i] (requested: %i bytes)\n";
static char __pyx_k_FATAL_Could_not_allocate_memory_5[] = "FATAL: Could not allocate memory for NS holder\n";
static char __pyx_k_FATAL_Could_not_allocate_memory_6[] = "FATAL: Could not allocate memory for NS holder.neighborhoods (requested: %i bytes)\n";
...
static PyObject *__pyx_kp_s_Performing_a_neighbor_search_on;
 ...
 *             grid.ncells[i] = 1
 */
    (__pyx_v_grid.ncells[__pyx_v_i]) = ((fsl_int)(((__pyx_v_box[__pyx_v_i])[__pyx_v_i]) / __pyx_v_cutoff));
 ...
 */
    (__pyx_v_grid.cellsize[__pyx_v_i]) = (((__pyx_v_box[__pyx_v_i])[__pyx_v_i]) / (__pyx_v_grid.ncells[__pyx_v_i]));
  }
 ...
 *         abort()
 */
    fprintf(stderr, __pyx_k_FATAL_Could_not_allocate_memory, ((sizeof(fsl_int)) * __pyx_v_grid_size));
 ...
 *         abort()
 */
    fprintf(stderr, __pyx_k_FATAL_Could_not_allocate_memory_2, ((sizeof(fsl_int)) * __pyx_v_grid_size));
 ...
 *         abort()
 */
    fprintf(stderr, __pyx_k_FATAL_Could_not_allocate_memory_3, ((sizeof(fsl_int *)) * __pyx_v_grid_size));
 ...
 *             abort()
 */
      fprintf(stderr, __pyx_k_FATAL_Could_not_allocate_memory_4, ((sizeof(fsl_int)) * (__pyx_v_allocated_size[__pyx_v_i])));
 ...
 */
    __pyx_t_4 = __pyx_v_cellindex;
    (__pyx_v_grid->nbeads[__pyx_t_4]) = ((__pyx_v_grid->nbeads[__pyx_t_4]) + 1);
 ...
 */
      __pyx_t_4 = __pyx_v_cellindex;
      (__pyx_v_allocated_size[__pyx_t_4]) = ((__pyx_v_allocated_size[__pyx_t_4]) + 10);
 ...
 */
        for (__pyx_t_5 = 2; __pyx_t_5 > -1L; __pyx_t_5-=1) {
          __pyx_v_m = __pyx_t_5;
 ...
 */
              __pyx_t_8 = __pyx_v_d;
              (__pyx_v_shifted_coord[__pyx_t_8]) = ((__pyx_v_shifted_coord[__pyx_t_8]) + ((__pyx_v_box->c_pbcbox.box[__pyx_v_m])[__pyx_v_d]));
            }
          }
 ...
 *                     d2 = rvec_norm2(dx)
 */
          __pyx_t_9 = __pyx_v_bid;
          __pyx_t_10 = 0;
          if (__pyx_t_9 < 0) __pyx_t_9 += __pyx_v_neighborcoords.shape[0];
          if (__pyx_t_10 < 0) __pyx_t_10 += __pyx_v_neighborcoords.shape[1];
          ((struct __pyx_vtabstruct_10fatslimlib_9core_base_PBCBox *)__pyx_v_box->__pyx_vtab)->fast_pbc_dx(__pyx_v_box, __pyx_v_current_coords, (&(*((real *) ( /* dim=1 */ ((char *) (((real *) ( /* dim=0 */ (__pyx_v_neighborcoords.data + __pyx_t_9 * __pyx_v_neighborcoords.strides[0]) )) + __pyx_t_10)) )))), __pyx_v_dx);
 ...
 *         abort()
 */
    fprintf(stderr, __pyx_k_FATAL_Could_not_allocate_memory_5, ((sizeof(fsl_int)) * __pyx_v_ncoords));
 ...
 *         abort()
 */
    fprintf(stderr, __pyx_k_FATAL_Could_not_allocate_memory_6, ((sizeof(struct __pyx_t_10fatslimlib_7core_ns_ns_neighborhood)) * __pyx_v_ncoords));
...
static PyMethodDef __pyx_mdef_10fatslimlib_7core_ns_1neighbor_search = {"neighbor_search", (PyCFunction)__pyx_pw_10fatslimlib_7core_ns_1neighbor_search, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_10fatslimlib_7core_ns_1neighbor_search(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("neighbor_search (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_ref_coords)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("neighbor_search", 0, 2, 4, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 326; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (kw_args > 0) {
          PyObject* value = PyDict_GetItem(__pyx_kwds, __pyx_n_s_neighbor_coords);
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "neighbor_search") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 326; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else {
    ...
    __pyx_v_ref_coords = __Pyx_PyObject_to_MemoryviewSlice_d_dc_nn_real(values[1]); if (unlikely(!__pyx_v_ref_coords.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 326; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    if (values[2]) {
      __pyx_v_neighbor_coords = __Pyx_PyObject_to_MemoryviewSlice_d_dc_nn_real(values[2]); if (unlikely(!__pyx_v_neighbor_coords.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 326; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_neighbor_coords = __pyx_k_;
      __PYX_INC_MEMVIEW(&__pyx_v_neighbor_coords, 1);
    }
    if (values[3]) {
      __pyx_v_cutoff = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_cutoff == (real)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 326; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
  ...
  __Pyx_RaiseArgtupleInvalid("neighbor_search", 0, 2, 4, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 326; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("fatslimlib.core_ns.neighbor_search", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_box), __pyx_ptype_10fatslimlib_9core_base_PBCBox, 1, "box", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 326; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 * 
 */
  __pyx_t_1 = PyInt_FromSsize_t((__pyx_v_ref_coords.shape[0])); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 332; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  __pyx_t_2 = PyFloat_FromDouble(__pyx_v_cutoff); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 333; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyInt_From_fsl_int(__pyx_v_10fatslimlib_9core_base_OPENMP_NUM_THREADS); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 333; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  __pyx_t_2 = 0;
  __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyString_Format(__pyx_kp_s_Performing_a_neighbor_search_on, __pyx_t_4); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 332; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (__Pyx_PrintOne(0, __pyx_t_3) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 332; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  __pyx_t_5 = ((struct __pyx_vtabstruct_10fatslimlib_9core_base_PBCBox *)__pyx_v_box->__pyx_vtab)->fast_put_atoms_in_bbox(__pyx_v_box, __pyx_v_ref_coords); if (unlikely(!__pyx_t_5.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 336; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_ref_coords_bbox = __pyx_t_5;
 ...
 *     else:
 */
  __pyx_t_6 = ((((PyObject *) __pyx_v_neighbor_coords.memview) == Py_None) != 0);
  if (__pyx_t_6) {
 ...
 */
  /*else*/ {
    __pyx_t_5 = ((struct __pyx_vtabstruct_10fatslimlib_9core_base_PBCBox *)__pyx_v_box->__pyx_vtab)->fast_put_atoms_in_bbox(__pyx_v_box, __pyx_v_neighbor_coords); if (unlikely(!__pyx_t_5.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 341; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __pyx_v_neighbor_coords_box = __pyx_t_5;
    __pyx_t_5.memview = NULL;
    __pyx_t_5.data = NULL;
  }
  __pyx_L3:;
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_empty); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 352; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = __Pyx_PyInt_From_fsl_int(__pyx_v_neighborhood->size); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 352; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    ...
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_9 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_int64); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 352; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_9);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_dtype, __pyx_t_9) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 352; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    __pyx_t_9 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_2, __pyx_t_3); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 352; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_9);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_XDECREF_SET(__pyx_v_neighborhood_py, __pyx_t_9);
    __pyx_t_9 = 0;
 ...
 */
    __pyx_t_10 = __pyx_v_neighborhood->size;
 ...
 * 
 */
      __pyx_t_9 = __Pyx_PyInt_From_fsl_int((__pyx_v_neighborhood->beadids[__pyx_v_i])); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 354; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_9);
      if (unlikely(__Pyx_SetItemInt(__pyx_v_neighborhood_py, __pyx_v_i, __pyx_t_9, fsl_int, 1, __Pyx_PyInt_From_fsl_int, 0, 1, 0) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 354; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    }
 ...
 * 
 */
    __pyx_t_12 = __Pyx_PyList_Append(__pyx_v_neighbors, __pyx_v_neighborhood_py); if (unlikely(__pyx_t_12 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 355; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_Performing_a_neighbor_search_on, __pyx_k_Performing_a_neighbor_search_on, sizeof(__pyx_k_Performing_a_neighbor_search_on), 0, 0, 1, 0},
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initcore_ns(void); /*proto*/
PyMODINIT_FUNC initcore_ns(void)
#else
PyMODINIT_FUNC PyInit_core_ns(void); /*proto*/
PyMODINIT_FUNC PyInit_core_ns(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_core_ns(void)", 0);
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "fatslimlib.core_ns")) {
      if (unlikely(PyDict_SetItemString(modules, "fatslimlib.core_ns", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  if (__Pyx_ExportFunction("fast_neighbor_search", (void (*)(void))__pyx_f_10fatslimlib_7core_ns_fast_neighbor_search, "struct __pyx_t_10fatslimlib_7core_ns_ns_neighborhood_holder *(__Pyx_memviewslice, __Pyx_memviewslice, struct __pyx_obj_10fatslimlib_9core_base_PBCBox *, real)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("free_neighborhood_holder", (void (*)(void))__pyx_f_10fatslimlib_7core_ns_free_neighborhood_holder, "void (struct __pyx_t_10fatslimlib_7core_ns_ns_neighborhood_holder *)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  /*--- Type init code ---*/
  ...
  /*--- Type import code ---*/
  __pyx_ptype_10fatslimlib_9core_base_Atom = __Pyx_ImportType("fatslimlib.core_base", "Atom", sizeof(struct __pyx_obj_10fatslimlib_9core_base_Atom), 1); if (unlikely(!__pyx_ptype_10fatslimlib_9core_base_Atom)) {__pyx_filename = __pyx_f[2]; __pyx_lineno = 58; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_10fatslimlib_9core_base_AtomGroup = __Pyx_ImportType("fatslimlib.core_base", "AtomGroup", sizeof(struct __pyx_obj_10fatslimlib_9core_base_AtomGroup), 1); if (unlikely(!__pyx_ptype_10fatslimlib_9core_base_AtomGroup)) {__pyx_filename = __pyx_f[2]; __pyx_lineno = 71; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_ptype_10fatslimlib_9core_base_PBCBox = __Pyx_ImportType("fatslimlib.core_base", "PBCBox", sizeof(struct __pyx_obj_10fatslimlib_9core_base_PBCBox), 1); if (unlikely(!__pyx_ptype_10fatslimlib_9core_base_PBCBox)) {__pyx_filename = __pyx_f[2]; __pyx_lineno = 90; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_vtabptr_10fatslimlib_9core_base_PBCBox = (struct __pyx_vtabstruct_10fatslimlib_9core_base_PBCBox*)__Pyx_GetVtable(__pyx_ptype_10fatslimlib_9core_base_PBCBox->tp_dict); if (unlikely(!__pyx_vtabptr_10fatslimlib_9core_base_PBCBox)) {__pyx_filename = __pyx_f[2]; __pyx_lineno = 90; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_10fatslimlib_9core_base_TopologyGroup = __Pyx_ImportType("fatslimlib.core_base", "TopologyGroup", sizeof(struct __pyx_obj_10fatslimlib_9core_base_TopologyGroup), 1); if (unlikely(!__pyx_ptype_10fatslimlib_9core_base_TopologyGroup)) {__pyx_filename = __pyx_f[2]; __pyx_lineno = 122; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_vtabptr_10fatslimlib_9core_base_TopologyGroup = (struct __pyx_vtabstruct_10fatslimlib_9core_base_TopologyGroup*)__Pyx_GetVtable(__pyx_ptype_10fatslimlib_9core_base_TopologyGroup->tp_dict); if (unlikely(!__pyx_vtabptr_10fatslimlib_9core_base_TopologyGroup)) {__pyx_filename = __pyx_f[2]; __pyx_lineno = 122; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_10fatslimlib_9core_base_Topology = __Pyx_ImportType("fatslimlib.core_base", "Topology", sizeof(struct __pyx_obj_10fatslimlib_9core_base_Topology), 1); if (unlikely(!__pyx_ptype_10fatslimlib_9core_base_Topology)) {__pyx_filename = __pyx_f[2]; __pyx_lineno = 140; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_vtabptr_10fatslimlib_9core_base_Topology = (struct __pyx_vtabstruct_10fatslimlib_9core_base_Topology*)__Pyx_GetVtable(__pyx_ptype_10fatslimlib_9core_base_Topology->tp_dict); if (unlikely(!__pyx_vtabptr_10fatslimlib_9core_base_Topology)) {__pyx_filename = __pyx_f[2]; __pyx_lineno = 140; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_10fatslimlib_9core_base_TopologyReader = __Pyx_ImportType("fatslimlib.core_base", "TopologyReader", sizeof(struct __pyx_obj_10fatslimlib_9core_base_TopologyReader), 1); if (unlikely(!__pyx_ptype_10fatslimlib_9core_base_TopologyReader)) {__pyx_filename = __pyx_f[2]; __pyx_lineno = 178; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_vtabptr_10fatslimlib_9core_base_TopologyReader = (struct __pyx_vtabstruct_10fatslimlib_9core_base_TopologyReader*)__Pyx_GetVtable(__pyx_ptype_10fatslimlib_9core_base_TopologyReader->tp_dict); if (unlikely(!__pyx_vtabptr_10fatslimlib_9core_base_TopologyReader)) {__pyx_filename = __pyx_f[2]; __pyx_lineno = 178; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_10fatslimlib_9core_base_CoordinateReader = __Pyx_ImportType("fatslimlib.core_base", "CoordinateReader", sizeof(struct __pyx_obj_10fatslimlib_9core_base_CoordinateReader), 1); if (unlikely(!__pyx_ptype_10fatslimlib_9core_base_CoordinateReader)) {__pyx_filename = __pyx_f[2]; __pyx_lineno = 187; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_vtabptr_10fatslimlib_9core_base_CoordinateReader = (struct __pyx_vtabstruct_10fatslimlib_9core_base_CoordinateReader*)__Pyx_GetVtable(__pyx_ptype_10fatslimlib_9core_base_CoordinateReader->tp_dict); if (unlikely(!__pyx_vtabptr_10fatslimlib_9core_base_CoordinateReader)) {__pyx_filename = __pyx_f[2]; __pyx_lineno = 187; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_10fatslimlib_9core_base_IndexReader = __Pyx_ImportType("fatslimlib.core_base", "IndexReader", sizeof(struct __pyx_obj_10fatslimlib_9core_base_IndexReader), 1); if (unlikely(!__pyx_ptype_10fatslimlib_9core_base_IndexReader)) {__pyx_filename = __pyx_f[2]; __pyx_lineno = 202; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_ptype_10fatslimlib_9core_base_Frame = __Pyx_ImportType("fatslimlib.core_base", "Frame", sizeof(struct __pyx_obj_10fatslimlib_9core_base_Frame), 1); if (unlikely(!__pyx_ptype_10fatslimlib_9core_base_Frame)) {__pyx_filename = __pyx_f[2]; __pyx_lineno = 211; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_vtabptr_10fatslimlib_9core_base_Frame = (struct __pyx_vtabstruct_10fatslimlib_9core_base_Frame*)__Pyx_GetVtable(__pyx_ptype_10fatslimlib_9core_base_Frame->tp_dict); if (unlikely(!__pyx_vtabptr_10fatslimlib_9core_base_Frame)) {__pyx_filename = __pyx_f[2]; __pyx_lineno = 211; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_10fatslimlib_9core_base_Trajectory = __Pyx_ImportType("fatslimlib.core_base", "Trajectory", sizeof(struct __pyx_obj_10fatslimlib_9core_base_Trajectory), 1); if (unlikely(!__pyx_ptype_10fatslimlib_9core_base_Trajectory)) {__pyx_filename = __pyx_f[2]; __pyx_lineno = 264; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_vtabptr_10fatslimlib_9core_base_Trajectory = (struct __pyx_vtabstruct_10fatslimlib_9core_base_Trajectory*)__Pyx_GetVtable(__pyx_ptype_10fatslimlib_9core_base_Trajectory->tp_dict); if (unlikely(!__pyx_vtabptr_10fatslimlib_9core_base_Trajectory)) {__pyx_filename = __pyx_f[2]; __pyx_lineno = 264; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  /*--- Variable import code ---*/
  __pyx_t_1 = __Pyx_ImportModule("fatslimlib.core_base"); if (!__pyx_t_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ImportVoidPtr(__pyx_t_1, "OPENMP_MAX_THREADS", (void **)&__pyx_vp_10fatslimlib_9core_base_OPENMP_MAX_THREADS, "fsl_int") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ImportVoidPtr(__pyx_t_1, "OPENMP_NUM_THREADS", (void **)&__pyx_vp_10fatslimlib_9core_base_OPENMP_NUM_THREADS, "fsl_int") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 * ########################################################################################################################
 */
  __pyx_t_2 = __Pyx_Import(__pyx_n_s_numpy, 0, -1); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 45; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_np, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 45; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 *     cdef fsl_int nid, i
 */
  __pyx_t_3 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_nn_real(Py_None);
  if (unlikely(!__pyx_t_3.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 326; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_k_ = __pyx_t_3;
  __pyx_t_3.memview = NULL;
  __pyx_t_3.data = NULL;
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_10fatslimlib_7core_ns_1neighbor_search, NULL, __pyx_n_s_fatslimlib_core_ns); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 326; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_neighbor_search, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 326; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 * cdef indirect = Enum("<strided and indirect>")
 */
  __pyx_t_2 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__17, NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 278; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
 ...
 * 
 */
  __pyx_t_2 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__18, NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 279; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
 ...
 * 
 */
  __pyx_t_2 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__19, NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 280; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
 ...
 * 
 */
  __pyx_t_2 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__20, NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 283; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
 ...
 * 
 */
  __pyx_t_2 = __Pyx_PyObject_Call(((PyObject *)__pyx_MemviewEnum_type), __pyx_tuple__21, NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 284; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
...
static CYTHON_INLINE fsl_int __Pyx_PyInt_As_fsl_int(PyObject *x) {
    ...
    if (likely(PyLong_Check(x))) {
        if (is_unsigned) {
            ...
            switch (Py_SIZE(x)) {
                case  0: return (fsl_int) 0;
                case -1: __PYX_VERIFY_RETURN_INT(fsl_int, sdigit, -(sdigit) digits[0])
                case  1: __PYX_VERIFY_RETURN_INT(fsl_int,  digit, +digits[0])
                case -2:
